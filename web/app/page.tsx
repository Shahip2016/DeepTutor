    ...
    <div className="h-screen flex flex-col animate-fade-in">
      ...
      {hasMessages && (
        <>
          ...
          <div className="flex items-center justify-between px-6 h-14 border-b border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl z-10">
            <div className="flex items-center gap-2">
              <div className="flex p-1 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 ${chatState.enableRag
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 ${chatState.enableWebSearch
                    ? "bg-white dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 shadow-sm scale-100"
                    : "text-slate-500 hover:text-slate-700 dark:hover:text-slate-300"
                    }`}
                >
                  <Globe className="w-3.5 h-3.5" />
              ...
              {chatState.enableRag && (
                <div className="relative group">
                  <select
                    ...
                    className="appearance-none text-xs font-bold bg-blue-50/50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 pl-3 pr-8 py-2 rounded-xl outline-none border border-blue-100 dark:border-blue-800 transition-all hover:bg-blue-100 dark:hover:bg-blue-900/40 cursor-pointer"
                  >
                    {kbs.map((kb) => (
                      <option key={kb.name} value={kb.name} className="dark:bg-slate-800">
                        {kb.name}
                      </option>
                    ))}
                  </select>
                  <div className="absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none text-blue-500/50">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-3.5 py-2 text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50/50 dark:bg-indigo-900/20 rounded-xl hover:bg-indigo-100 dark:hover:bg-indigo-900/40 transition-all active:scale-95 border border-indigo-100/50 dark:border-indigo-800/50"
              >
